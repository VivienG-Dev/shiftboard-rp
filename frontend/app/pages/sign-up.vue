        ...
        <div class="w-full max-w-md">
          ...
          <Card class="mt-6 border-border bg-card/60 shadow-xl backdrop-blur">
              ...
              <form @submit.prevent="onSubmit" class="space-y-4">
                <FormField v-slot="{ componentField }" name="name">
                  <FormItem>
                    ...
                    <FormControl>
                      <Input v-bind="componentField" placeholder="Your name" autocomplete="name" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                </FormField>
            ...
            <CardFooter class="flex flex-wrap items-center justify-between gap-2">
              ...
              <NuxtLink class="text-sm text-muted-foreground hover:text-foreground underline underline-offset-4" to="/sign-in">
        ...
        <div class="relative h-full p-10">
          <div class="max-w-lg">
            ...
            <p class="mt-4 text-muted-foreground">
              Create a company, invite staff, and keep your inventory accurate—shift after shift.
            </p>
          </div>
        </div>
      </div>
