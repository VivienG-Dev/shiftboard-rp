    ...
    <header class="relative z-10 mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-6">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <div class="text-xs text-muted-foreground">Night shift ops, organized.</div>
        </div>
      </div>
      ...
      <div class="grid items-center gap-10 lg:grid-cols-2">
        <div class="space-y-6">
          ...
          <p class="max-w-xl text-muted-foreground">
            Track inventory, shifts, and staff across multiple companies—built for GTA V RP communities.
          </p>
          ...
          <div v-if="isAuthenticated" class="rounded-xl border border-border bg-card/60 p-4">
            ...
            <pre class="mt-3 max-h-40 overflow-auto rounded-md bg-muted p-3 text-xs text-muted-foreground">{{ session }}</pre>
          </div>
        </div>
        ...
        <div class="relative hidden lg:block">
          ...
          <div
            ...
            <div class="absolute inset-0 bg-[url('/images/ls-skyline.svg')] bg-cover bg-center opacity-70" />
